...
namespace SalesWebMvc.Services
{
    public class CategoryService
    {
        ...
        {      
            return await _context.Categories.OrderBy(x => x.Name).ToListAsync();//a chamada to list executa a chamada e transforma o resultado para list(ToList() e uma operação Sincrona) e mudamos para ToListAsync, assim nao bloqueia a aplicação.
        }
